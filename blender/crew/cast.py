...
PIP = Spec(
    ...
    collar='shirt', buttons=3,
    torso=(0.78, 0.34, 0.95), shoulder_slope=0.14,
...
SACK = Spec(
    ...
    lid_shade=0.95,
    ears='none',
    collar='hood', buttons=0,
    neck=(0.165, 0.26),
    torso=(0.72, 0.34, 1.30), shoulder_slope=0.17,
...
ROSTER = dict([
    ...
    _v('sales', 'The sales guy', **BODY,
       ...
       lens_tint=1.0, tache='walrus', cig=True, lanyard=False,
